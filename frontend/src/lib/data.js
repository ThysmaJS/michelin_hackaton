...
// du catalogue).
// watts: résistance au roulement (les deux pneus, 80 kg total, 40 km/h, asphalte lisse)
// weightG: poids unitaire en grammes (pour calcul delta paire)
// races: palmarès / homologations course (Michelin uniquement)
export const tyres = {
  'power-cup':            { brand: 'Michelin', name: 'Power Cup', tag: 'Compétition route', usage: 'Course · route lisse', grip: 85, rendement: 94, endurance: 74, legerete: 89, weight: '215 g', weightG: 215, watts: 14, price: '54,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×23 à 28C', pressure: '4 – 8 bar', tubeless: false, races: ['Tour de France 2024', 'Paris-Roubaix 2024'], proTeams: ['Visma | Lease a Bike', 'UAE Team Emirates', 'Lidl-Trek'], proTips: ["Sec : 6.8–7.2 bar AR / 6.2–6.5 bar AV pour 70 kg. Réduire de 0.3 bar par conditions humides.", "Contrôler les flancs après chaque secteur pavé : les chocs répétés fragilisent la carcasse.", "Montage à froid : chauffer le pneu 20 min au soleil facilite le positionnement du talon."] },
  'power-cup-tlr':        { brand: 'Michelin', name: 'Power Cup TLR', tag: 'Compétition tubeless', usage: 'Course · tubeless', grip: 85, rendement: 94, endurance: 75, legerete: 84, weight: '270 g', weightG: 270, watts: 13, price: '69,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×25 à 32C', pressure: '3,5 – 8 bar', tubeless: true, races: ['Vuelta España 2024', 'Critérium du Dauphiné'], proTeams: ['Groupama-FDJ', 'Cofidis', 'Arkéa-B&B Hotels'], proTips: ["Sealant : 25–30 ml de Caffélatex ou Végétalex. Renouveler toutes les 6–8 semaines.", "Premier gonflage au compresseur pour faire sauter le talon, puis ajuster à la pression cible.", "Après un impact, agiter la roue pour redistribuer le sealant avant de repartir."] },
  'power-time-trial':     { brand: 'Michelin', name: 'Power Time Trial', tag: 'Contre-la-montre', usage: 'CLM · route lisse', grip: 85, rendement: 97, endurance: 63, legerete: 93, weight: '185 g', weightG: 185, watts: 12, price: '49,90 €', terrain: 'route', segment: 'Racing Line', rubber: 'GUM-X', sizes: '700×23 à 25C', pressure: '5 – 8 bar', tubeless: false, races: ['CLM UCI WorldTour'] },
  'power-road':           { brand: 'Michelin', name: 'Power Road', tag: 'Performance route', usage: 'Performance · route', grip: 85, rendement: 94, endurance: 74, legerete: 87, weight: '235 g', weightG: 235, watts: 15, price: '39,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×25C', pressure: '5 – 8 bar', tubeless: false, races: ['Paris-Nice 2024'], proTeams: ['AG2R Citroën', 'TotalEnergies'], proTips: ["Sweet spot pour 75 kg : 6.0 bar AV / 6.5 bar AR sur route sèche, idéal pour l'entraînement intensif.", "La gomme GUM-X reste performante jusqu'à 5 °C pour les sorties de demi-saison.", "Ne pas mélanger Power Road et concurrent sur le même vélo : les profils de rendement sont incompatibles."] },
  'power-road-tlr':       { brand: 'Michelin', name: 'Power Road TLR', tag: 'Performance tubeless', usage: 'Performance · tubeless', grip: 85, rendement: 94, endurance: 76, legerete: 82, weight: '290 g', weightG: 290, watts: 14, price: '54,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×25 à 32C', pressure: '5 – 8 bar', tubeless: true, races: [] },
  'pro5':                 { brand: 'Michelin', name: 'Pro5', tag: 'Endurance route', usage: 'Endurance · route', grip: 85, rendement: 82, endurance: 89, legerete: 86, weight: '250 g', weightG: 250, watts: 17, price: '44,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×25 à 32C', pressure: '5 – 7,5 bar', tubeless: false, races: [] },
  'power-all-season':     { brand: 'Michelin', name: 'Power All Season', tag: 'Toutes saisons', usage: 'Toutes saisons · route', grip: 93, rendement: 84, endurance: 90, legerete: 83, weight: '280 g', weightG: 280, watts: 19, price: '44,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'MAGI-X', sizes: '700×25 à 32C', pressure: '4 – 7,5 bar', tubeless: false, races: [], proTips: ["Par temps de pluie : 5.5 bar AV / 6.0 bar AR (70 kg) — plus de contact sur chaussée mouillée.", "La gomme MAGI-X reste souple jusqu'à −5 °C pour les entraînements hivernaux.", "Rincer à l'eau claire après chaque sortie humide : le sel de route attaque la carcasse."] },
  'lithion-4':            { brand: 'Michelin', name: 'Lithion 4', tag: 'Entraînement route', usage: 'Entraînement · route', grip: 90, rendement: 82, endurance: 87, legerete: 86, weight: '250 g', weightG: 250, watts: 18, price: '26,90 €', terrain: 'route', segment: 'Performance Line', rubber: 'MAGI-X', sizes: '700×23 à 32C', pressure: '3,2 – 8 bar', tubeless: false, races: [] },
  'power-protection-tlr': { brand: 'Michelin', name: 'Power Protection TLR', tag: 'Anti-crevaison', usage: 'Endurance · anti-crevaison', grip: 93, rendement: 84, endurance: 91, legerete: 77, weight: '330 g', weightG: 330, watts: 18, price: '54,90 €', terrain: 'route', segment: 'Competition Line', rubber: 'MAGI-X', sizes: '700×28 à 32C', pressure: '3 – 6 bar', tubeless: true, races: [] },
  'power-adventure':      { brand: 'Michelin', name: 'Power Adventure', tag: 'Aventure mixte', usage: 'Gravel · mixte', grip: 89, rendement: 84, endurance: 92, legerete: 73, weight: '370 g', weightG: 370, watts: 24, price: '44,90 €', terrain: 'gravel', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×30 à 48C', pressure: '2 – 5 bar', tubeless: true, races: [], proTips: ["Sur terrain humide : descendre à 2.0–2.5 bar — le tubeless élimine tout risque de pincement à cette pression.", "Usure centrale symétrique = pression correcte ; usure latérale = surpression à corriger."] },
  'power-gravel':         { brand: 'Michelin', name: 'Power Gravel', tag: 'Gravel polyvalent', usage: 'Gravel · chemin', grip: 94, rendement: 70, endurance: 94, legerete: 67, weight: '430 g', weightG: 430, watts: 29, price: '49,90 €', terrain: 'gravel', segment: 'Competition Line', rubber: 'MAGI-X', sizes: '700×33 à 50C', pressure: '1 – 5 bar', tubeless: true, races: [] },
  'power-gravel-rs':      { brand: 'Michelin', name: 'Power Gravel RS', tag: 'Gravel compétition', usage: 'Gravel · course', grip: 89, rendement: 90, endurance: 80, legerete: 65, weight: '445 g', weightG: 445, watts: 26, price: '64,90 €', terrain: 'gravel', segment: 'Racing Line', rubber: 'GUM-X', sizes: '700×42C', pressure: 'max 4,5 bar', tubeless: true, races: ['Championnats du Monde Gravel UCI'], proTeams: ['Canyon-SRAM', 'Specialized Factory Racing', 'Trek Factory Racing Gravel'], proTips: ["Pression gravel : 2.5–3.0 bar sur piste, 3.2–3.5 bar si retour sur asphalte.", "Orange Seal Endurance (45 ml) : sealant plébiscité sur le circuit UCI Gravel.", "La nuit avant une course : gonfler 0.3 bar au-dessus de la cible — le tubeless perd ~0.2 bar par nuit."] },
  'power-gravel-extreme': { brand: 'Michelin', name: 'Power Gravel Extreme', tag: 'Gravel extrême', usage: 'Gravel · terrain extrême', grip: 89, rendement: 67, endurance: 95, legerete: 51, weight: '580 g', weightG: 580, watts: 36, price: '57,90 €', terrain: 'gravel', segment: 'Competition Line', rubber: 'GUM-X', sizes: '700×42 à 48C', pressure: 'max 4,5 bar', tubeless: true, races: [] },
};
...
export const competitors = {
  'continental-gp5000':   { brand: 'Continental', name: 'Grand Prix 5000', usage: 'Endurance · route', grip: 88, rendement: 90, endurance: 80, legerete: 82, weight: '215 g', weightG: 215, watts: 13, price: '64,90 €', terrain: 'route', segment: 'Compétition', rubber: 'BlackChili', sizes: '700×25 à 32C', pressure: '5 – 8 bar', tubeless: false },
  'pirelli-pzero':        { brand: 'Pirelli', name: 'P Zero Race', usage: 'Compétition · route', grip: 90, rendement: 89, endurance: 72, legerete: 88, weight: '205 g', weightG: 205, watts: 15, price: '59,90 €', terrain: 'route', segment: 'Compétition', rubber: 'SmartEVO', sizes: '700×24 à 30C', pressure: '5 – 8 bar', tubeless: false },
  'vittoria-corsa':       { brand: 'Vittoria', name: 'Corsa N.EXT', usage: 'Course · route', grip: 87, rendement: 86, endurance: 78, legerete: 80, weight: '235 g', weightG: 235, watts: 16, price: '54,90 €', terrain: 'route', segment: 'Compétition', rubber: 'Graphene 2.0', sizes: '700×24 à 30C', pressure: '5 – 8 bar', tubeless: false },
  'schwalbe-proone':      { brand: 'Schwalbe', name: 'Pro One', usage: 'Course · route', grip: 86, rendement: 88, endurance: 76, legerete: 84, weight: '250 g', weightG: 250, watts: 13, price: '57,90 €', terrain: 'route', segment: 'Compétition', rubber: 'Addix Race', sizes: '700×25 à 32C', pressure: '4,5 – 8 bar', tubeless: true },
  'continental-terra':    { brand: 'Continental', name: 'Terra Speed', usage: 'Gravel · chemin', grip: 80, rendement: 74, endurance: 86, legerete: 70, weight: '335 g', weightG: 335, watts: 22, price: '56,90 €', terrain: 'gravel', segment: 'Gravel', rubber: 'BlackChili', sizes: '700×35 à 45C', pressure: '2 – 4,5 bar', tubeless: true },
  'panaracer-gravelking': { brand: 'Panaracer', name: 'GravelKing SK', usage: 'Gravel · mixte', grip: 82, rendement: 70, endurance: 88, legerete: 66, weight: '350 g', weightG: 350, watts: 29, price: '46,90 €', terrain: 'gravel', segment: 'Gravel', rubber: 'ZSG', sizes: '700×32 à 50C', pressure: '2 – 4,5 bar', tubeless: true },
};
